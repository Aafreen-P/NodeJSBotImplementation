...
var httpClient = new HttpClient();
 ...
 async function createRemedyIncident()
  {
   ...
   var optionsForCreateIncidentUpdateRequest = { 
    url: "http://VTRVITSTP-03:8008/api/arsys/v1/entry/HPD:IncidentInterface_Create",
    method: 'POST',
    json: { "values": {
      "First_Name": "Aafreen",
      "Last_Name": "Patel",
      "Description": "Aafreen-Test Incident for BMC-Teams Integration POC from Node Program",
      "TemplateID": "AG00123F73CF5EKnsTSQ5rvrAAZfQA",
      "Login_ID": "Aafreen_Patel",
  ...
  let createStatusCode=await createIncident(optionsForCreateIncidentUpdateRequest);
  console.log("create incident status code:"+JSON.stringify(createStatusCode))
  return await createStatusCode;
  }
 ...
 // await createRemedyIncident();
})();


module.exports.createRemedyIncident=createRemedyIncident;