...
async testTeams(context,inc) {
    ...
    let updateStatusCode= await updateRemedyWorklog.updateRemedyWorklog(messageDetails,inc,step);
...
else
{
    ...
    let updateStatusCode= await updateRemedyWorklog.updateRemedyWorklog(messageDetails,inc);
    await  context.sendActivity(`Your message 'Remedy updated success fully' '${updateStatusCode}' `);
}
